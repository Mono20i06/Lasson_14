class Snake:
    ...
    def __init__(self, screen, size=4, pos=(100, 100,), block_size=20, direction="up"):
        self.size = size
        self.pos = pos
    ...
    def make_step(self):
        self.blocks.insert(0,
                           (
                               self.blocks[0][0] + (self.block_size * self.directions[self.direction][0]),
                               self.blocks[0][0] + (self.block_size * self.directions[self.direction][1])
